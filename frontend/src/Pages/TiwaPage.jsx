...
function TiwaPage(){
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get("http://localhost:4000/api/products/category/tiwa"); // Use correct category
    ...
    return (
        <div>
            ...
            <div className="container">
                <h2 style={{textAlign:"center"}}>Tiwa</h2>
                <div className="row">

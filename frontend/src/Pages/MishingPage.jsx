...
function MishingPage(){
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get("http://localhost:4000/api/products/category/mishing"); // Use correct category
    ...
    return (
        <div>  
            ...
            <div className="container">
                <h2 style={{textAlign:"center"}}>Mishing</h2>
                <div className="row">
